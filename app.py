...
def generate_explanation_route(current_user_id):
    ...
    try:
        ...
        prompt = ""
        if mode == 'explain':
            prompt = f"Explain the concept of '{word}' in 2-4 concise sentences. Also, identify up to 3 distinct key sub-topics or related concepts within your explanation and wrap them with <click>tags</click> like this: <click>sub-topic</click>."
        elif mode == 'fact':
